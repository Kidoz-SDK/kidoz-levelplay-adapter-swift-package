...
#ifndef KIDOZIRONSOURCEADAPTER_SWIFT_H
#define KIDOZIRONSOURCEADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KidozIronSourceAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ISKidozCustomAdapter")
@interface ISKidozCustomAdapter : ISBaseNetworkAdapter <KidozInitDelegate>
...
- (NSString * _Null_unspecified)networkSDKVersion SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_NAMED("ISKidozCustomBanner")
@interface ISKidozCustomBanner : ISBaseBanner <KidozBannerDelegate>
...
- (nonnull instancetype)initWithAdFormat:(NSString * _Nonnull)adFormat adapterConfig:(ISAdapterConfig * _Nonnull)adapterConfig OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithAdFormat:(NSString * _Nonnull)adFormat adapterConfig:(ISAdapterConfig * _Nonnull)adapterConfig adUnitObjectId:(NSUUID * _Nullable)adUnitObjectId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_NAMED("ISKidozCustomInterstitial")
@interface ISKidozCustomInterstitial : ISBaseInterstitial <KidozInterstitialDelegate>
...
SWIFT_CLASS_NAMED("ISKidozCustomRewardedVideo")
@interface ISKidozCustomRewardedVideo : ISBaseRewardedVideo <KidozRewardedDelegate>
...
SWIFT_CLASS_NAMED("KidozIronSourceSDKInfo")
@interface KidozIronSourceSDKInfo : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
